...
alter table if exists order_details_products
    add constraint order_details_products_fk_products
    foreign key (product_id) references products;
alter table if exists order_details_products
    add constraint order_details_products_fk_orders_details
    foreign key (order_details_id) references orders_details;
